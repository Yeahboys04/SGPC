...
<br/></center>";
	...
	$mess = $mess."<h2><center> Inventaire total </center></h2>
	<br/><br/>
	<table border = \"1\" width = 100%>";
	
	// On cre un tableau, qui va, pour chaque ligne dresser les caractéristiques de chaque produit
	
	$mess = $mess."<th><a href=\"Inventaire.php\">Nom du produit/Num Cas</a></th>
	<th>Purete</th>
	<th><a href=\"Inventaire.php?tri=Lieu\">Lieu de stockage</a></th>
	<th><a href=\"Inventaire.php?tri=Proprietaire\">Propriétaire</a></th>
	<th><a href=\"Inventaire.php?tri=Quantite\">Quantite</a></th>
