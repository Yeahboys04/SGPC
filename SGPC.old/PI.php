...
if (isset($_POST['Intitule_ajout'])) {
	...
	try {
		...
		$req->execute(array(
				...
				echo '<script>alert("Insertion réussie");window.location.replace("PI.php");</script>';
	}catch (Exception $e) {
	...
	echo '<script>alert("Ce moyen de protection individuel existe déjà");history.back();</script>';
	...
	try {
		...
		echo '<script>alert("Modification effectuée");window.location.replace("PI.php");</script>';
	} catch (Exception $e) {
	...
	try {
		...
		echo '<script>alert("Suppression effectuée");window.location.replace("PI.php");</script>';
	} catch (Exception $e) {
		echo '<script>alert("Erreur");history.back();</script>';
	}
	}
