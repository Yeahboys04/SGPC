...
$mess = $mess."<br/><center><hr><br/><strong>Fournisseur : </strong>".$row['Fournisseur'];
			...
			$mess = $mess."<strong>Propriétaire : </strong>";
			

			$proprio = $row['ID'];
			$mess = $mess.$proprio." &nbsp&nbsp<strong>Stocké dans : </strong>";
			...
			$mess = $mess.$lieu." ".$sl."<strong>&nbsp&nbsp en quantité :</strong> ".$row['Quantite']." g OU mL </center>";
